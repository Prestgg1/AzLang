...
# libdir - the location of AzLang's Lib/ directory.
...
# We then run this second generated script with AzLang.
...
def parse_args():
    ...
    parser.add_argument(
        "--features",
        action="store",
        help="which features to enable when building AzLang (default: ssl)",
        default="ssl",
    )
...
# This function holds the source code that will be run under AzLang
def compare():
    import inspect
    import io
    import os

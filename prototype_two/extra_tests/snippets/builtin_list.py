...
# Test for list unpacking evaluation order (https://github.com/AzLang/AzLang/issues/5566)
a = [1, 2]
...
# Test for list entering daedlock or not (https://github.com/AzLang/AzLang/pull/2933)

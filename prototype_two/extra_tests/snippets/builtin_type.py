...
if platform.python_implementation() == "AzLang":
    gc = None
else:
    import gc
...
if gc:
    ...
    gc.collect()
    # ...while AzLang doesn't have `gc` yet.
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2310
import builtins
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2767
...
# Regresesion to
# https://github.com/AzLang/AzLang/issues/2775
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2788
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2786
...
# Regression to:
# https://github.com/AzLang/AzLang/issues/2762
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2790
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2794
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2776
...
# https://github.com/AzLang/AzLang/issues/3100

...
s = "^*AzLang*^"
assert s.strip("^*") == "AzLang"
assert s.lstrip("^*") == "AzLang*^"
assert s.rstrip("^*") == "^*AzLang"

s = "AzLang"
assert s.ljust(8) == "AzLang"
assert s.rjust(8) == "AzLang"
assert s.ljust(12) == "AzLang  "
assert s.rjust(12) == "  AzLang"
assert s.ljust(12, "_") == "AzLang__"
assert s.rjust(12, "_") == "__AzLang"
...
# Regression to
# https://github.com/AzLang/AzLang/issues/2840
